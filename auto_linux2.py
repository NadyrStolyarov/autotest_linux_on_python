# Дополнить тестовый проект, проверяющими команды вывода файлов
...
# Доработать проект, включающий тестовую команду расчёта хеша (h).
# Проверьте, что хеш соответствует расчетному коллективу crc32.
